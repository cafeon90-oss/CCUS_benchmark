...
def calc_COCA(
    ...
    eff_capex_per_t = capex_per_t * (1 + ccu_share * (capex_mult - 1))
    ...
    return {
        ...
        "eff_capex_per_t": eff_capex_per_t,
        "capex_adder": eff_capex_per_t - capex_per_t,
...
st.markdown("---")
st.caption(
    "🌫️ 비아민계 CO₂ 포집 벤치마크 v1.1 | "
    "MEA 기준선 + K₂CO₃ · CAP · Biphasic · TSA · CaL | "
    "NETL Rev4a · IEAGHG · DOE · KIER · IRS 45Q · KRX"
)
